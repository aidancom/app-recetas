...
const Sidebar = () => { 
  ...
  return (
    <div className='bg-slate-300 h-full m-3 p-3'>
      ...
      <form className="flex flex-col space-y-2 pt-5">
        ...
        <input type="button" value="Eliminar filtro" className="bg-[#A11F1F] uppercase font-medium text-[13px] py-1 text-white rounded-sm" onClick={handleClearFilter}/>
      </form>
    </div>
  )
}
